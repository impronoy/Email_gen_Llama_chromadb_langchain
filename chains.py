...
class Chain:
    ...
    def write_mail(self, job, links):
        prompt_email = PromptTemplate.from_template(
            ...
            ### INSTRUCTION:
            You are Pronoy, a business development Analyst at Cognizant. Cognizant is an AI & Software Consulting company dedicated to facilitating
            ...
            Remember you are Pronoy, BDA at Cognizant. 
